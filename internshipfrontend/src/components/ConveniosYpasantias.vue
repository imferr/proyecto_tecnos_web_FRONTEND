<template>
        ...
        <div class="internship-container">
          <div class="internship-list">
            ...
            <div class="internship-item">
              ...
              <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam  consectetur adipiscing elit, sed do eiusmod tempor incididunt...</p>
              <button class="add-button" @click="verPasantias">VER PASANTÍAS</button>
            </div>
          </div>
        </div>
      </div>
  ...
  import ConveniosYpasantiasAPI from '../services/ConveniosYpasantiasAPI.js';
  
  export default {
    components: {
      AppNavbar,
    },
    mixins: [ConveniosYpasantiasAPI],
    name: 'CardSection',
